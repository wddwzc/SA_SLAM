...
static LaserSlamWorkerParams getLaserSlamWorkerParams(const ros::NodeHandle& nh,
  ...
  nh.getParam(ns + "/distance_to_consider_fixed", params.distance_to_consider_fixed);  // none
  nh.getParam(ns + "/separate_distant_map", params.separate_distant_map);	// none
  nh.getParam(ns + "/create_filtered_map", params.create_filtered_map);
  nh.getParam(ns + "/minimum_distance_to_add_pose", params.minimum_distance_to_add_pose); // none
  nh.getParam(ns + "/voxel_size_m", params.voxel_size_m);	// none
  ...
  nh.getParam(ns + "/ground_distance_to_robot_center_m", params.ground_distance_to_robot_center_m);	// none
  ...
  nh.getParam(ns + "/get_laser_track_srv_topic", params.get_laser_track_srv_topic);	// none
...
static laser_slam::LaserTrackParams getLaserTrackParams(const ros::NodeHandle& nh,
  ...
  nh.getParam(ns + "/add_m_estimator_on_icp", params.add_m_estimator_on_icp);
	...
	// TODO 加载 icp_configuration_file  icp_input_filters_file
