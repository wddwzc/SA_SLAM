...
// 将 PointPairs 中的匹配点对用 Marker 表示出来
...
// ros PointCloud2 转 pcl PointCloudXYZI
...
// pcl PointCloudXYZI 转 ros PointCloud2
...
// pcl PointCloud 转 ros PointCloud2
...
// 加载 SegMatch 参数，赋值给 SegMatchParams
static segmatch::SegMatchParams getSegMatchParams(const ros::NodeHandle& nh,
  ...
  nh.getParam(ns + "/radius_for_normal_estimation_m",
              params.radius_for_normal_estimation_m);	// none
  nh.getParam(ns + "/normal_estimator_type",
              params.normal_estimator_type);	// none
  ...
  nh.getParam(ns + "/Segmenters/sc_smoothness_threshold_deg",
              params.segmenter_params.sc_smoothness_threshold_deg);	// none
  nh.getParam(ns + "/Segmenters/sc_curvature_threshold",
              params.segmenter_params.sc_curvature_threshold);	// none

  // Classifier parameters.
  nh.getParam(ns + "/Classifier/classifier_filename",
              params.classifier_params.classifier_filename);	// none
  ...
  nh.getParam(ns + "/Classifier/rf_max_depth",
              params.classifier_params.rf_max_depth);	// none
  nh.getParam(ns + "/Classifier/rf_min_sample_ratio",
              params.classifier_params.rf_min_sample_ratio);	// none
  nh.getParam(ns + "/Classifier/rf_regression_accuracy",
              params.classifier_params.rf_regression_accuracy);	// none
  nh.getParam(ns + "/Classifier/rf_use_surrogates",
              params.classifier_params.rf_use_surrogates);	// none
  nh.getParam(ns + "/Classifier/rf_max_categories",
              params.classifier_params.rf_max_categories);	// none
  nh.getParam(ns + "/Classifier/rf_priors",
              params.classifier_params.rf_priors);	// none
  nh.getParam(ns + "/Classifier/rf_calc_var_importance",
              params.classifier_params.rf_calc_var_importance);	// none
  nh.getParam(ns + "/Classifier/rf_n_active_vars",
              params.classifier_params.rf_n_active_vars);	// none
  nh.getParam(ns + "/Classifier/rf_max_num_of_trees",
              params.classifier_params.rf_max_num_of_trees);	// none
  nh.getParam(ns + "/Classifier/rf_accuracy",
              params.classifier_params.rf_accuracy);	// none
...
// 加载 SegMatchWorker 参数，赋值给 SegMatchWorkerParams
